...
public class TaskTest {
    ...
    public void shouldMapStringsToUpperCase() {
        ...
        List<String> result = Task.mapToUpperCase(input);
    ...
    public void shouldReturnSquareRoot() {
        ...
        List<Integer> squares = Task.returnSquareRoot(numbers);
    ...
    public void shouldReturnAgeFromUser() {
        ...
        List<Integer> ageFromUsers = Task.getAgeFromUsers(users);
    ...
    public void shouldReturnFirstTwo() {
        ...
        users = Task.getLimitedUserList(users, 2);
    ...
    public void shouldReturnNumberOfUsersOlderThen25() {
        ...
        Integer count = Task.countUsersOlderThen25(users);
        assertTrue(count == 1);
    }
    ...
    public void shouldReturnDistinctAges() {
        ...
        List<Integer> distinctAges = Task.getDistinctAges(users);
    ...
    public void shouldSumIntegersInCollection() {
        ...
        Integer result = Task.sum(integers);
    ...
    public void shouldSkipInCollection() {
        List<Integer> integers = asList(1, 2, 3, 4, 5);
        List<Integer> result = Task.skip(integers, 2);
    ...
    public void shouldReturnFirstNames() {
        ...
        List<String> result = Task.getFirstNames(names);
    ...
    public void shouldReturnDistinctLetters() {
        List<String> names = asList("Homer Simpson", "Marge Simpson", "Bart Simpson", "Kent Brockman");
        List<String> result = Task.getDistinctLetters(names);
    ...
    public void shouldSeparateNamesByComma() {
        List<User> input = asList(
                ...
                new User("Maggie"),
                new User("Bart"));
        String result = Task.separateNamesByComma(input);
    ...
    public void shouldPerformCalculations() {
        ...
        assertEquals(Task.getMinAge(users), (Integer) 10);
        assertEquals(Task.getMaxAge(users), (Integer) 30);
        assertEquals(Task.getAverageAge(users), (double) (10 + 20 + 30) / 3, 0);
    }
    ...
    public void shouldGroupByAge() {
        ...
        List<User> input = asList(homer, bart, maggie, lisa);
        Map<Integer, List<User>> result = Task.groupByAge(input);
    ...
    public void shouldGroupByGenderAndAge() {
        ...
        List<User> input = asList(homer, bart, maggie, lisa);
        Map<Boolean, Map<Integer, List<User>>> result = Task.groupByGenderAndAge(input);
    ...
    public void shouldCountGender() {
        ...
        User lisa = new User("Lisa", 8, false);
        List<User> input = asList(homer, bart, maggie, lisa);
        Map<Boolean, Long> result = Task.countGender(input);
    ...
    public void shouldMatchAge() {
        List<User> users = User.getUsersWithAge(10, 20, 30);
        assertTrue(Task.anyMatch(users, 10));
    }

    @Test
    public void shouldNoneMatchAge() {
        List<User> users = User.getUsersWithAge(10, 20, 30);
        assertTrue(Task.noneMatch(users, 40));
    }
    ...
    public void shouldFindAnyUser() {
        ...
        Optional<User> user = Task.findAny(users, "Homer");
    ...
    public void shouldSortByAge() {
        ...
        User lisa = new User("Lisa", 8);
        List<User> users = asList(homer, bart, maggie, lisa);
        List<User> sorted = Task.sortByAge(users);
    ...
    public void shouldFindOldest() {
        ...
        User lisa = new User("Lisa", 8);
        List<User> users = asList(homer, bart, maggie, lisa);
        User oldest = Task.findOldest(users);
    ...
    public void shouldGenerateAgeSummaryStatistics() {
        ...
        User lisa = new User("Lisa", 8);
        List<User> users = asList(homer, bart, maggie, lisa);
        IntSummaryStatistics statistics = Task.ageSummaryStatistics(users);
    ...
    public void shouldConvertToBoxedStream() {
        ...
        Stream<Integer> boxedStream = Task.getBoxedStream(intStream);
        assertTrue(boxedStream.count() == 3);
    }

    @Test
    public void shouldGenerate10RandomNumbers() {
        List<Integer> randomNumbers = Task.generate10RandomNumbers();
        assertTrue(randomNumbers.size() == 10);
    }

    @Test
    public void shouldGenerateFirstPrimeNumbers() {
        List<Integer> primeNumbers = Task.generateFirst10PrimeNumbers();
